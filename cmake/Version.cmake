...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/.git")
  # treat changing .env as if it were tagged even if that hasn't happened yet
  execute_process(COMMAND git log -n1 --pretty=%H -- .env OUTPUT_STRIP_TRAILING_WHITESPACE OUTPUT_VARIABLE VERSION_HASH)
  execute_process(COMMAND git rev-parse --verify HEAD OUTPUT_STRIP_TRAILING_WHITESPACE OUTPUT_VARIABLE FULL_HASH)
  if ("${VERSION_HASH}" STREQUAL "${FULL_HASH}")
    message("Using new version from .env")
  else()
